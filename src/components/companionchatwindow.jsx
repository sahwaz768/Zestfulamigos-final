...
const Companionchatwindow = () => {
  ...
  const [isOpenex2model, setIsOpenex2model] = useState(false);

  const openModal = () => setIsOpenexmodel(true);
  const closeModal = () => setIsOpenexmodel(false);

  const openModal2 = () => setIsOpenex2model(true);
  const closeModal2 = () => setIsOpenex2model(false);
  return (
    <>
      {isOpenexmodel && (
      ...
      {isOpenex2model && (
        <div className="extension-modal-overlay">
          <div className="extension-modal-content flex justify-center">
      ...
      <div className="chat-window">
            ...
            <div className="user-details">
              ...
              {isOpen && (
                <ul className="dropdown-menu-extension">
                  ...
                  <div className="extension-slote mt-1" onClick={openModal2}>
                    end session
                  </div>
                </ul>
              )}
        ...
        <div className="chat-input">
          <div className="chat-input-container">
            ...
            />
            <div className="send-button-x flex">

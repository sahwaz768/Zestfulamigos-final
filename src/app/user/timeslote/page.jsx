...
const Page = () => {
  ...
  return (
   ...
   <Guidmodel/>
    ...
    <div className='top-timeslotebox  '>
      <div className="timeslotebox">
        <h1 className="text-black  font-semibold my-4 md:text-2xl">Time Slot and Date Availability</h1>
        <div className="flex ">
      ...
      <div className="timeslotebox">
        ...
        <h1 className="mt-4 mb-2 font-bold text-sm">Specify the Location for Companion Meet-Up</h1>

...
const page = () => {
  ...
  return (
    <div>
      ...
      <h1 className='md:text-xl ml-3 font-bold mt-2'>Your support requests</h1>
      </div>
        <div className='support' onClick={openModal}>
        <FiPlus color='red' />
        <h1 className='md:text-sm text-xs font-bold'>MAKE SUPPORT REQUEST</h1>
        </div>
        
      </div>
      <div className='support-box-head'>
     <div className='support-row-head md:text-xl text-xs'>
      Ticket no
     </div>
     <div className='support-row-head md:text-xl text-xs'>
      Topic
     ...
     <div className='support-row-2-head md:text-xl text-xs'>
      check
     </div>
     ...
     <div className='support-row md:text-sm font-bold text-xs'>
      #12345
     </div>
     <div className='support-row md:text-sm font-bold text-xs'>
      Balance error
     </div>
     <div className='support-row md:text-sm font-bold pending text-xs'>
      pending
     </div>
    <div className='support-row-2 md:text-sm font-bold text-xs'>
     <Link href={'/user/ticket'}> <h1>view</h1> </Link>
     </div>
     ...
     <Link href={'/user/ticket'}> <h1>view</h1> </Link>
      ...
      <div className="form-group">
        <label htmlFor="problem" className='text-sm'>Problem related</label>
        <textarea
          id="problem"
          name="problem"
      ...
      <div className="form-group">
        <label htmlFor="elaborateProblem" className='text-sm'>Elaborate Your Problem:</label>
        <textarea
          id="elaborateProblem"
      ...
      <div className="form-group">
        <label htmlFor="image" className='text-sm'>Attachment (optional):</label>
        <input
          type="file"
          id="image"
          name="image"

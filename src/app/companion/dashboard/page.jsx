                    ...
                    <div className="w-full">
                      <div className="overflow-x-auto ">
                        <div className="flex gap-4 md:gap-2  pb-4 min-w-min md:min-w-full">
                          {bookingData?.upcomingBookingsList?.length ===
                          0 ? (
                                ...
                                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                                  ...
                                  <div className="p-8 text-center">
                                    ...
                                    <p className="text-gray-500 mb-6">
                                      You don't have any bookings  at the
                                      moment.
                                    </p>
                                  </div>
                                </div>
                    ...
                    <div className="w-full lg:w-1/4 ">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Link href={'/companion/chat'}>
                          {' '}
                          <div className="group bg-white text-gray-900 rounded-xl py-8 px-4 font-bold hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col items-center justify-center gap-2 text-xs shadow-md">
                            <span className="text-2xl group-hover:scale-125 transition-transform duration-300">
                              💬
                            </span>
                            <span className="text-center leading-tight">
